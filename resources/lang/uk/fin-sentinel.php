...
return [
    ...
    'settings' => [
        ...
        'ai' => [
            ...
            'test_connection_success' => 'З\'єднання з ШІ працює.',
            'test_connection_failed' => 'З\'єднання з ШІ не вдалося.',
            'test_connection_missing' => 'Для перевірки з\'єднання потрібні постачальник, модель та API-ключ.',
            'test_connection_no_sdk' => 'SDK ШІ (laravel/ai) не встановлено.',
            'section' => 'ШІ-аналіз',
